        ...
        <div className='relative px-4 sm:px-6 lg:px-8'>
          ...
          <div className='mt-6 prose prose-pink prose-lg text-gray-500 mx-auto'>
            <p>
              ...
              <strong>Dignissim</strong> sed. Mattis mauris semper sed amet
            ...
            <figure>
              <img
                ...
                src='https://images.unsplash.com/photo-1531297484001-80022131f5a1?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&q=80'
                alt=''
                width={1000}
                height={600}
              />
            ...
            <h2>The help you need any time you feel stuck</h2>
            <p>
              Id orci tellus laoreet id ac. Dolor, aenean leo, ac etiam
              consequat in. Convallis arcu ipsum urna nibh. Pharetra, euismod
              vitae interdum mauris enim, consequat vulputate nibh. Maecenas
            ...
            <figure>
              <img
                className='w-full rounded-lg'
                src='https://images.unsplash.com/photo-1530893609608-32a9af3aa95c?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&q=80'
                alt=''
                width={1000}
                height={600}
              />
            ...
            <h2>A thriving community of developers</h2>
            <p>
              Purus morbi dignissim senectus mattis <a href='#'>adipiscing</a>.
              Amet, massa quam varius orci dapibus volutpat cras. In amet eu
              ridiculus leo sodales cursus tristique. Tincidunt sed tempus ut
